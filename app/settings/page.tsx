...
import { LucideBarChart, LucidePalette, LucideUser } from "lucide-react";
                ...
                <div className="w-full h-[90vh] md:w-[80vw] lg:w-[70vw] xl:w-[60vw]">
                    <div className="rounded-3xl bg-white dark:bg-gray-800 p-12 shadow-2xl h-full flex flex-col items-center overflow-auto">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full">
                            ...
                            >
                                <LucideUser className="text-blue-500 mb-4 w-10 h-10" />
                                <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
                                    Account Management
                                </h2>
                                <p className="text-gray-600 dark:text-gray-300 text-center mt-2">
                                    Manage your account details and user settings.
                                </p>
                            </motion.div>
                            ...
                            <motion.div
                                ...
                                transition={{ type: "spring", stiffness: 300 }}
                            >
                                <LucidePalette className="text-green-500 mb-4 w-10 h-10" />
                                <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
                                    Theme Customization
                                </h2>
                                <p className="text-gray-600 dark:text-gray-300 text-center mt-2">
                            ...
                            <motion.div
                                ...
                                transition={{ type: "spring", stiffness: 300 }}
                            >
                                <LucideBarChart className="text-yellow-500 mb-4 w-10 h-10" />
                                <h2 className="text-xl md:text-2xl font-bold text-gray-900 dark:text-white">
                                    Data Analytics
                                </h2>
                                <p className="text-gray-600 dark:text-gray-300 text-center mt-2">
                                    Review your usage data and app performance metrics.
                                </p>
                            </motion.div>
                        </div>
                            ...
                            >
                                ...
                                <div className="relative z-10">
                                    <p className="text-base md:text-lg font-semibold">
                                        More settings options will be available soon. Stay tuned!
                                    </p>
                                </div>
                                <motion.div
